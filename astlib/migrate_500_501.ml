...
and copy_expression_desc :
  ...
  | Ast_500.Parsetree.Pexp_sequence (x0, x1) ->
      Ast_501.Parsetree.Pexp_sequence
        ((copy_expression x0), (copy_expression x1))
  | Ast_500.Parsetree.Pexp_while (x0, x1) ->
      Ast_501.Parsetree.Pexp_while
        ((copy_expression x0), (copy_expression x1))
  ...
  | Ast_500.Parsetree.Pexp_constraint (x0, x1) ->
      Ast_501.Parsetree.Pexp_constraint
...
and copy_pattern_desc :
  Ast_500.Parsetree.pattern_desc -> Ast_501.Parsetree.pattern_desc =
  function
  ...
  | Ast_500.Parsetree.Ppat_interval (x0, x1) ->
      Ast_501.Parsetree.Ppat_interval
  ...
  | Ast_500.Parsetree.Ppat_variant (x0, x1) ->
      Ast_501.Parsetree.Ppat_variant
  ...
  | Ast_500.Parsetree.Ppat_constraint (x0, x1) ->
      Ast_501.Parsetree.Ppat_constraint
  ...
  | Ast_500.Parsetree.Ppat_open (x0, x1) ->
      Ast_501.Parsetree.Ppat_open
        ((copy_loc copy_Longident_t x0), (copy_pattern x1))
and copy_core_type :
  Ast_500.Parsetree.core_type -> Ast_501.Parsetree.core_type =
  fun
...
and copy_row_field :
  Ast_500.Parsetree.row_field -> Ast_501.Parsetree.row_field =
  fun
...
and copy_attribute :
  Ast_500.Parsetree.attribute -> Ast_501.Parsetree.attribute =
  fun
...
and copy_payload : Ast_500.Parsetree.payload -> Ast_501.Parsetree.payload =
  ...
  | Ast_500.Parsetree.PPat (x0, x1) ->
      Ast_501.Parsetree.PPat
        ((copy_pattern x0), (Option.map copy_expression x1))
and copy_structure :
  Ast_500.Parsetree.structure -> Ast_501.Parsetree.structure =
...
and copy_structure_item_desc :
  ...
  | Ast_500.Parsetree.Pstr_extension (x0, x1) ->
      Ast_501.Parsetree.Pstr_extension
...
and copy_class_expr_desc :
  ...
  | Ast_500.Parsetree.Pcl_constraint (x0, x1) ->
      Ast_501.Parsetree.Pcl_constraint
...
and copy_class_structure :
  ...
  fun
    ...
    ->
    {
      ...
      Ast_501.Parsetree.pcstr_fields =
...
and copy_class_field_kind :
  ...
  | Ast_500.Parsetree.Cfk_concrete (x0, x1) ->
      Ast_501.Parsetree.Cfk_concrete
...
and copy_with_constraint :
  ...
  | Ast_500.Parsetree.Pwith_modsubst (x0, x1) ->
      Ast_501.Parsetree.Pwith_modsubst
        ((copy_loc copy_Longident_t x0), (copy_loc copy_Longident_t x1))
and copy_signature :
  Ast_500.Parsetree.signature -> Ast_501.Parsetree.signature =
...
and copy_signature_item_desc :
  ...
  | Ast_500.Parsetree.Psig_extension (x0, x1) ->
      Ast_501.Parsetree.Psig_extension
        ((copy_extension x0), (copy_attributes x1))
...
and copy_class_signature :
  ...
  fun
    ...
    ->
    {
      ...
      Ast_501.Parsetree.pcsig_fields =
...
and copy_extension :
  Ast_500.Parsetree.extension -> Ast_501.Parsetree.extension =
  fun x ->
    let (x0, x1) = x in ((copy_loc (fun x -> x) x0), (copy_payload x1))
and copy_class_infos :
  'f0 'g0 .
    ('f0 -> 'g0) ->
      'f0 Ast_500.Parsetree.class_infos -> 'g0 Ast_501.Parsetree.class_infos
  =
  fun f0 ->
    fun
...
and copy_virtual_flag :
  Ast_500.Asttypes.virtual_flag -> Ast_501.Asttypes.virtual_flag =
  function
...
and copy_open_infos :
  'f0 'g0 .
    ('f0 -> 'g0) ->
      'f0 Ast_500.Parsetree.open_infos -> 'g0 Ast_501.Parsetree.open_infos
  =
  fun f0 ->
    fun
...
and copy_override_flag :
  Ast_500.Asttypes.override_flag -> Ast_501.Asttypes.override_flag =
  function
...
and copy_mutable_flag :
  Ast_500.Asttypes.mutable_flag -> Ast_501.Asttypes.mutable_flag =
  function
...
and copy_injectivity :
  Ast_500.Asttypes.injectivity -> Ast_501.Asttypes.injectivity =
  function
...
and copy_closed_flag :
  Ast_500.Asttypes.closed_flag -> Ast_501.Asttypes.closed_flag =
  function
  | Ast_500.Asttypes.Closed -> Ast_501.Asttypes.Closed
  | Ast_500.Asttypes.Open -> Ast_501.Asttypes.Open
and copy_label : Ast_500.Asttypes.label -> Ast_501.Asttypes.label =
  fun x -> x
...
and copy_loc :
  ...
  fun f0 ->
    fun { Ast_500.Asttypes.txt = txt; Ast_500.Asttypes.loc = loc } ->
      {
        Ast_501.Asttypes.txt = (f0 txt);
        Ast_501.Asttypes.loc = (copy_location loc)
      }
