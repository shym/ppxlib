...
and copy_toplevel_directive :
  ...
  =
  fun
    { Ast_501.Parsetree.pdir_name = pdir_name;
      Ast_501.Parsetree.pdir_arg = pdir_arg;
      Ast_501.Parsetree.pdir_loc = pdir_loc }
    ->
    {
...
and copy_directive_argument :
  ...
  =
  fun
    { Ast_501.Parsetree.pdira_desc = pdira_desc;
      Ast_501.Parsetree.pdira_loc = pdira_loc }
    ->
    {
...
and copy_expression :
  ...
  fun
    { Ast_501.Parsetree.pexp_desc = pexp_desc;
      Ast_501.Parsetree.pexp_loc = pexp_loc;
      Ast_501.Parsetree.pexp_loc_stack = pexp_loc_stack;
      Ast_501.Parsetree.pexp_attributes = pexp_attributes }
    ->
    {
...
and copy_letop : Ast_501.Parsetree.letop -> Ast_500.Parsetree.letop =
  fun
    { Ast_501.Parsetree.let_ = let_; Ast_501.Parsetree.ands = ands;
      Ast_501.Parsetree.body = body }
    ->
    {
...
and copy_binding_op :
  ...
  fun
    { Ast_501.Parsetree.pbop_op = pbop_op;
      Ast_501.Parsetree.pbop_pat = pbop_pat;
      Ast_501.Parsetree.pbop_exp = pbop_exp;
      Ast_501.Parsetree.pbop_loc = pbop_loc }
    ->
    {
...
and copy_case : Ast_501.Parsetree.case -> Ast_500.Parsetree.case =
  fun
    { Ast_501.Parsetree.pc_lhs = pc_lhs;
      Ast_501.Parsetree.pc_guard = pc_guard;
      Ast_501.Parsetree.pc_rhs = pc_rhs }
    ->
    {
...
and copy_value_binding :
  ...
  fun
    { Ast_501.Parsetree.pvb_pat = pvb_pat;
      Ast_501.Parsetree.pvb_expr = pvb_expr;
      Ast_501.Parsetree.pvb_attributes = pvb_attributes;
      Ast_501.Parsetree.pvb_loc = pvb_loc }
    ->
    {
...
and copy_pattern : Ast_501.Parsetree.pattern -> Ast_500.Parsetree.pattern =
  fun
    { Ast_501.Parsetree.ppat_desc = ppat_desc;
      Ast_501.Parsetree.ppat_loc = ppat_loc;
      Ast_501.Parsetree.ppat_loc_stack = ppat_loc_stack;
      Ast_501.Parsetree.ppat_attributes = ppat_attributes }
    ->
    {
...
and copy_pattern_desc :
  Ast_501.Parsetree.pattern_desc -> Ast_500.Parsetree.pattern_desc =
  function
...
and copy_core_type :
  Ast_501.Parsetree.core_type -> Ast_500.Parsetree.core_type =
  fun
    { Ast_501.Parsetree.ptyp_desc = ptyp_desc;
      Ast_501.Parsetree.ptyp_loc = ptyp_loc;
      Ast_501.Parsetree.ptyp_loc_stack = ptyp_loc_stack;
      Ast_501.Parsetree.ptyp_attributes = ptyp_attributes }
    ->
    {
...
and copy_row_field :
  Ast_501.Parsetree.row_field -> Ast_500.Parsetree.row_field =
  fun
    { Ast_501.Parsetree.prf_desc = prf_desc;
      Ast_501.Parsetree.prf_loc = prf_loc;
      Ast_501.Parsetree.prf_attributes = prf_attributes }
    ->
    {
...
and copy_object_field :
  ...
  fun
    { Ast_501.Parsetree.pof_desc = pof_desc;
      Ast_501.Parsetree.pof_loc = pof_loc;
      Ast_501.Parsetree.pof_attributes = pof_attributes }
    ->
    {
...
and copy_attribute :
  Ast_501.Parsetree.attribute -> Ast_500.Parsetree.attribute =
  fun
    { Ast_501.Parsetree.attr_name = attr_name;
      Ast_501.Parsetree.attr_payload = attr_payload;
      Ast_501.Parsetree.attr_loc = attr_loc }
    ->
    {
...
and copy_structure :
  Ast_501.Parsetree.structure -> Ast_500.Parsetree.structure =
...
and copy_structure_item :
  ...
  fun
    { Ast_501.Parsetree.pstr_desc = pstr_desc;
      Ast_501.Parsetree.pstr_loc = pstr_loc }
    ->
    {
...
and copy_class_expr :
  ...
  fun
    { Ast_501.Parsetree.pcl_desc = pcl_desc;
      Ast_501.Parsetree.pcl_loc = pcl_loc;
      Ast_501.Parsetree.pcl_attributes = pcl_attributes }
    ->
    {
...
and copy_class_structure :
  ...
  fun
    { Ast_501.Parsetree.pcstr_self = pcstr_self;
      Ast_501.Parsetree.pcstr_fields = pcstr_fields }
    ->
    {
...
and copy_class_field :
  ...
  fun
    { Ast_501.Parsetree.pcf_desc = pcf_desc;
      Ast_501.Parsetree.pcf_loc = pcf_loc;
      Ast_501.Parsetree.pcf_attributes = pcf_attributes }
    ->
    {
...
and copy_module_binding :
  ...
  fun
    { Ast_501.Parsetree.pmb_name = pmb_name;
      Ast_501.Parsetree.pmb_expr = pmb_expr;
      Ast_501.Parsetree.pmb_attributes = pmb_attributes;
      Ast_501.Parsetree.pmb_loc = pmb_loc }
    ->
    {
...
and copy_module_expr :
  ...
  fun
    { Ast_501.Parsetree.pmod_desc = pmod_desc;
      Ast_501.Parsetree.pmod_loc = pmod_loc;
      Ast_501.Parsetree.pmod_attributes = pmod_attributes }
    ->
    {
...
and copy_module_expr_desc :
  ...
  | Ast_501.Parsetree.Pmod_apply_unit x0 ->
      let empty_struct = Ast_500.Parsetree.({
...
and copy_module_type :
  ...
  fun
    { Ast_501.Parsetree.pmty_desc = pmty_desc;
      Ast_501.Parsetree.pmty_loc = pmty_loc;
      Ast_501.Parsetree.pmty_attributes = pmty_attributes }
    ->
    {
...
and copy_with_constraint :
  ...
  | Ast_501.Parsetree.Pwith_modsubst (x0, x1) ->
      Ast_500.Parsetree.Pwith_modsubst
        ((copy_loc copy_Longident_t x0), (copy_loc copy_Longident_t x1))
and copy_signature :
  Ast_501.Parsetree.signature -> Ast_500.Parsetree.signature =
...
and copy_signature_item :
  ...
  fun
    { Ast_501.Parsetree.psig_desc = psig_desc;
      Ast_501.Parsetree.psig_loc = psig_loc }
    ->
    {
...
and copy_class_type :
  ...
  fun
    { Ast_501.Parsetree.pcty_desc = pcty_desc;
      Ast_501.Parsetree.pcty_loc = pcty_loc;
      Ast_501.Parsetree.pcty_attributes = pcty_attributes }
    ->
    {
...
and copy_class_signature :
  ...
  fun
    { Ast_501.Parsetree.pcsig_self = pcsig_self;
      Ast_501.Parsetree.pcsig_fields = pcsig_fields }
    ->
    {
...
and copy_class_type_field :
  ...
  fun
    { Ast_501.Parsetree.pctf_desc = pctf_desc;
      Ast_501.Parsetree.pctf_loc = pctf_loc;
      Ast_501.Parsetree.pctf_attributes = pctf_attributes }
    ->
    {
...
and copy_extension :
  Ast_501.Parsetree.extension -> Ast_500.Parsetree.extension =
  fun x ->
    let (x0, x1) = x in ((copy_loc (fun x -> x) x0), (copy_payload x1))
and copy_class_infos :
  'f0 'g0 .
    ('f0 -> 'g0) ->
      'f0 Ast_501.Parsetree.class_infos -> 'g0 Ast_500.Parsetree.class_infos
  =
  fun f0 ->
    fun
      { Ast_501.Parsetree.pci_virt = pci_virt;
        Ast_501.Parsetree.pci_params = pci_params;
        Ast_501.Parsetree.pci_name = pci_name;
        Ast_501.Parsetree.pci_expr = pci_expr;
        Ast_501.Parsetree.pci_loc = pci_loc;
        Ast_501.Parsetree.pci_attributes = pci_attributes }
      ->
      {
...
and copy_virtual_flag :
  Ast_501.Asttypes.virtual_flag -> Ast_500.Asttypes.virtual_flag =
  function
...
and copy_include_infos :
  ...
  fun f0 ->
    fun
      { Ast_501.Parsetree.pincl_mod = pincl_mod;
        Ast_501.Parsetree.pincl_loc = pincl_loc;
        Ast_501.Parsetree.pincl_attributes = pincl_attributes }
      ->
      {
...
and copy_open_infos :
  'f0 'g0 .
    ('f0 -> 'g0) ->
      'f0 Ast_501.Parsetree.open_infos -> 'g0 Ast_500.Parsetree.open_infos
  =
  fun f0 ->
    fun
      { Ast_501.Parsetree.popen_expr = popen_expr;
        Ast_501.Parsetree.popen_override = popen_override;
        Ast_501.Parsetree.popen_loc = popen_loc;
        Ast_501.Parsetree.popen_attributes = popen_attributes }
      ->
      {
...
and copy_override_flag :
  Ast_501.Asttypes.override_flag -> Ast_500.Asttypes.override_flag =
  function
...
and copy_module_type_declaration :
  ...
  =
  fun
    { Ast_501.Parsetree.pmtd_name = pmtd_name;
      Ast_501.Parsetree.pmtd_type = pmtd_type;
      Ast_501.Parsetree.pmtd_attributes = pmtd_attributes;
      Ast_501.Parsetree.pmtd_loc = pmtd_loc }
    ->
    {
...
and copy_module_substitution :
  ...
  =
  fun
    { Ast_501.Parsetree.pms_name = pms_name;
      Ast_501.Parsetree.pms_manifest = pms_manifest;
      Ast_501.Parsetree.pms_attributes = pms_attributes;
      Ast_501.Parsetree.pms_loc = pms_loc }
    ->
    {
...
and copy_module_declaration :
  ...
  =
  fun
    { Ast_501.Parsetree.pmd_name = pmd_name;
      Ast_501.Parsetree.pmd_type = pmd_type;
      Ast_501.Parsetree.pmd_attributes = pmd_attributes;
      Ast_501.Parsetree.pmd_loc = pmd_loc }
    ->
    {
...
and copy_type_exception :
  ...
  fun
    { Ast_501.Parsetree.ptyexn_constructor = ptyexn_constructor;
      Ast_501.Parsetree.ptyexn_loc = ptyexn_loc;
      Ast_501.Parsetree.ptyexn_attributes = ptyexn_attributes }
    ->
    {
...
and copy_type_extension :
  ...
  fun
    { Ast_501.Parsetree.ptyext_path = ptyext_path;
      Ast_501.Parsetree.ptyext_params = ptyext_params;
      Ast_501.Parsetree.ptyext_constructors = ptyext_constructors;
      Ast_501.Parsetree.ptyext_private = ptyext_private;
      Ast_501.Parsetree.ptyext_loc = ptyext_loc;
      Ast_501.Parsetree.ptyext_attributes = ptyext_attributes }
    ->
    {
...
and copy_extension_constructor :
  ...
  =
  fun
    { Ast_501.Parsetree.pext_name = pext_name;
      Ast_501.Parsetree.pext_kind = pext_kind;
      Ast_501.Parsetree.pext_loc = pext_loc;
      Ast_501.Parsetree.pext_attributes = pext_attributes }
    ->
    {
...
and copy_type_declaration :
  ...
  fun
    { Ast_501.Parsetree.ptype_name = ptype_name;
      Ast_501.Parsetree.ptype_params = ptype_params;
      Ast_501.Parsetree.ptype_cstrs = ptype_cstrs;
      Ast_501.Parsetree.ptype_kind = ptype_kind;
      Ast_501.Parsetree.ptype_private = ptype_private;
      Ast_501.Parsetree.ptype_manifest = ptype_manifest;
      Ast_501.Parsetree.ptype_attributes = ptype_attributes;
      Ast_501.Parsetree.ptype_loc = ptype_loc }
    ->
    {
...
and copy_private_flag :
  Ast_501.Asttypes.private_flag -> Ast_500.Asttypes.private_flag =
  function
  | Ast_501.Asttypes.Private -> Ast_500.Asttypes.Private
  | Ast_501.Asttypes.Public -> Ast_500.Asttypes.Public
and copy_type_kind :
  Ast_501.Parsetree.type_kind -> Ast_500.Parsetree.type_kind =
  function
...
and copy_constructor_declaration :
  ...
  =
  fun
    { Ast_501.Parsetree.pcd_name = pcd_name;
      Ast_501.Parsetree.pcd_vars = pcd_vars;
      Ast_501.Parsetree.pcd_args = pcd_args;
      Ast_501.Parsetree.pcd_res = pcd_res;
      Ast_501.Parsetree.pcd_loc = pcd_loc;
      Ast_501.Parsetree.pcd_attributes = pcd_attributes }
    ->
    {
...
and copy_label_declaration :
  ...
  =
  fun
    { Ast_501.Parsetree.pld_name = pld_name;
      Ast_501.Parsetree.pld_mutable = pld_mutable;
      Ast_501.Parsetree.pld_type = pld_type;
      Ast_501.Parsetree.pld_loc = pld_loc;
      Ast_501.Parsetree.pld_attributes = pld_attributes }
    ->
    {
...
and copy_mutable_flag :
  Ast_501.Asttypes.mutable_flag -> Ast_500.Asttypes.mutable_flag =
  function
...
and copy_injectivity :
  Ast_501.Asttypes.injectivity -> Ast_500.Asttypes.injectivity =
  function
...
and copy_value_description :
  ...
  =
  fun
    { Ast_501.Parsetree.pval_name = pval_name;
      Ast_501.Parsetree.pval_type = pval_type;
      Ast_501.Parsetree.pval_prim = pval_prim;
      Ast_501.Parsetree.pval_attributes = pval_attributes;
      Ast_501.Parsetree.pval_loc = pval_loc }
    ->
    {
...
and copy_closed_flag :
  Ast_501.Asttypes.closed_flag -> Ast_500.Asttypes.closed_flag =
  function
  | Ast_501.Asttypes.Closed -> Ast_500.Asttypes.Closed
  | Ast_501.Asttypes.Open -> Ast_500.Asttypes.Open
and copy_label : Ast_501.Asttypes.label -> Ast_500.Asttypes.label =
  fun x -> x
...
and copy_loc :
  ...
  =
  fun f0 ->
    fun { Ast_501.Asttypes.txt = txt; Ast_501.Asttypes.loc = loc } ->
      {
